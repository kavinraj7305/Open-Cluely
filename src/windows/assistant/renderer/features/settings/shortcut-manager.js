...
const shortcutIconById = {
    ...
    codingAi: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8.3 6.3 2.6 12l5.7 5.7 1.4-1.4L5.4 12l4.3-4.3-1.4-1.4zm7.4 0-1.4 1.4L18.6 12l-4.3 4.3 1.4 1.4L21.4 12l-5.7-5.7z"/></svg>',
    ...
    quitApp: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M10.09 15.59 11.5 17l5-5-5-5-1.41 1.41L12.67 11H3v2h9.67l-2.58 2.59zM19 3H5c-1.11 0-2 .9-2 2v4h2V5h14v14H5v-4H3v4c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/></svg>',
